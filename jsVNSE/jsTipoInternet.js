$("#botonenviar").click(function() {
    if ($("#FormVNSE").valid()) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": localStorage.getItem("urlApi")+'addTipoInternet',
            "method": "POST",
            "headers": {
...
function deleteAction(data) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            var settings = {
                "url": localStorage.getItem("urlApi")+'deleteTipoInternet/' + data,
                "method": "GET",
                "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
            ...
            $.ajax(settings).done(function(response) {
                Bitacora(localStorage.getItem("IdUsuario"),localStorage.getItem("IP"),"Borrar Frecuencia Electricidad (IdTipoInternet)",data,"D");
...
function ActualizarRegistro() {
    if ($("#FormVNSEEdit").valid()) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": localStorage.getItem("urlApi")+'updateTipoInternet',
            "method": "POST",
            "headers": {
                "Content-Type": "application/x-www-form-urlencoded",
                "Authorization": "Bearer " + localStorage.getItem('Token')
        ...
        $.ajax(settings).done(function(response) {
            Bitacora(localStorage.getItem("IdUsuario"),localStorage.getItem("IP"),"Actualizar TipoInternet (Id)",$("#inputIdEditVNSE").val(),"U");
            let xtable = $('#TableVNSE').DataTable();
            xtable.ajax.reload(null, false);
            const Toast = Swal.mixin({
                toast: true,
...
function EditAction(data) {
    ...
    var settings = {
        "url": localStorage.getItem("urlApi")+'getTipoInternetId/' + data,
        "method": "GET",
        "headers": {
            "Content-Type": "application/x-www-form-urlencoded",
            "Authorization": "Bearer " + localStorage.getItem('Token')
    ...
    $.ajax(settings).done(function(response) {
        Bitacora(localStorage.getItem("IdUsuario"),localStorage.getItem("IP"),"Consulta TipoInternet (Id)",data,"R");
...
function cargarTabla(){
    ...
    $('#TableVNSE').dataTable({
        ...
        "ajax": {
            "url": localStorage.getItem("urlApi")+'getAllTipoInternet/',
            "type": "GET",
            "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
