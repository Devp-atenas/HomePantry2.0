...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="bi bi-layers-half"></i>&nbsp;Mantenimiento ViajeVacacional</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">ViajeVacacional</h3>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <div class="inputText font-weight-bold">ViajeVacacional:</div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Listado ViajeVacacional</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
...
<script src="<?php echo base_url('jsVNSE/jsViajeVacacional.js') ?>"></script>
