...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="bi bi-currency-exchange"></i>&nbsp;Mantenimiento Gastos</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <div class="inputText font-weight-bold">Gastos:</div>
...
<script src="<?php echo base_url('jsVNSE/jsGastos.js') ?>"></script>
