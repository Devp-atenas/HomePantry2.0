  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Mantenimiento de Tiendas:</h1>
          </div>
          <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Listados de Tiendas</h3>
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="TableLogErrores" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>ID</th>
                    <th>ID Semana</th>
...
$('#TableLogErrores').dataTable({
        ...
        "ajax":{
                "url": '<?php echo urlApi; ?>getErrores',
                "type": "GET",
        ...
        "aoColumns": [
              ...
              { mData: 'id_semana',className: "text-center"},
              { mData: 'Archivo',className: "text-center"},
              { mData: 'Mensaje',className: "text-center"},
              { mData: 'Linea',className: "text-center"},
              { mData: 'fecha',className: "text-center"}
            ]  ,
            "columnDefs": [ {
            "targets": 6,
            "orderable": true,
            ...
            return '<a title="Eliminar" href="#"></a>&nbsp;&nbsp;<a title="Visualizar" href="#"><img src=<?php echo base_url('assets/iconos/ver.png')?> width="25" height="25" onclick="VisualizarAction('+data+'); return false;"></a>';}
        }],
      });
});
</script>
