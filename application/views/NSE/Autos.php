...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="fas fa-shapes"></i>&nbsp;Mantenimiento de Autos</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <div class="inputText font-weight-bold">Autos</div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="number" step="0.01" class="form-control input-sm" id="pesoAdd" placeholder="Ingrese peso ...">
                                </div>
                            </div>
                            <div class="col-md-2">
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Listados de Autos</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            ...
                            <form id="FormNSEEdit">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <div class="inputText font-weight-bold">Peso:</div>
                                            <input type="number" step="0.01" class="form-control input-sm" id="pesoEdit" placeholder="Ingrese Peso ...">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="inputText font-weight-bold">Activo:</div>
...
function EditAction(data) {
    var settings = {
        "url": '<?php echo urlApi; ?>getAutosId/' + data,
        "method": "get",
        "headers": {
...
function deleteAction(data) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            var settings = {
                "url": '<?php echo urlApi; ?>deleteAutos/' + data,
                "method": "get",
                "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
...
function ActualizarRegistro() {
    if ($("#FormNSEEdit").valid()) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": '<?php echo urlApi; ?>updateAutos',
            "method": "post",
            "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
...
$(document).ready(function() {
    ...
    $('#TableCategoria').dataTable({
        ...
        "ajax": {
            "url": '<?php echo urlApi;?>getAllAutos2',
            "type": "GET",
            "headers": {
                /*'Authorization': 'bearer ' + localStorage.getItem('Token')*/
            },
