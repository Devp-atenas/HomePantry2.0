...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="fas fa-shapes"></i>&nbsp;Mantenimiento de Nivel de Educacion:</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    <div class="inputText font-weight-bold">Nivel de Educacion:</div>
...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Listados de Educacion</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Nivel de Educacion</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
...
function EditAction(data) {
    var settings = {
        "url": '<?php echo urlApi; ?>getNivelEducacionId/' + data,
        "method": "get",
        "headers": {
...
function deleteAction(data) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            var settings = {
                "url": '<?php echo urlApi; ?>deleteNivelEducacion/' + data,
                "method": "get",
                "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
...
function ActualizarRegistro() {
    if ($("#FormNSEEdit").valid()) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": '<?php echo urlApi; ?>updateNivelEducacion',
            "method": "post",
            "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
...
$(document).ready(function() {
    ...
    $("#botonenviar").click(function() {
        if ($("#FormNSE").valid()) {
            var settings = {
                "async": true,
                "crossDomain": true,
                "url": '<?php echo urlApi; ?>addNivelEducacion',
                "method": "POST",
                "headers": {
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Authorization": "Bearer " + localStorage.getItem('Token')
    ...
    $('#TableCategoria').dataTable({
        ...
        "ajax": {
            "url": '<?php echo urlApi;?>getAllNivelEducacion',
            "type": "GET",
            "headers": {
                /*'Authorization': 'bearer ' + localStorage.getItem('Token')*/
            },
