...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Maestro Producto Pharmatencion:</h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Productos Pharmatencion </h3>
            ...
            <div class="modal fade" id="modal-PharmatencionVisualizar">
                            ...
                            <div class="col-md-12">
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="NombreVer" class="row">
                                            <div class="col-md-6">
                                                <label for="inputNombresVer">Campo 1:</label>
                                                <input type="text" name="nombres" id="Campo1"
                                                    class="form-control form-control-sm" readonly>
                                            </div>
                                            <div id="NombreVer" class="col-md-6">
                                                <label for="inputNombresVer">Campo 2:</label>
                                                <input type="text" name="nombres" id="Campo2"
                                                    class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                        <div id="NombreVer" class="row">
                                            <div class="col-md-6">
                                                <label for="inputNombresVer">Campo 3 :</label>
                                                <input type="text" name="nombres" id="Campo3"
                                                    class="form-control form-control-sm" readonly>
                                            </div>
                                            <div id="NombreVer" class="col-md-6">
                                                <label for="inputNombresVer">Campo 4:</label>
                                                <input type="text" name="nombres" id="Campo4"
                                                    class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                        <div id="NombreVer" class="row">
                                            <div id="NombreVer" class="col-md-6">
                                                <label for="inputNombresVer">Campo 5:</label>
                                                <input type="text" name="nombres" id="Campo5"
                                                    class="form-control form-control-sm" readonly>
                                            </div>
                                            <div id="NombreVer" class="col-md-6">
                                                <label for="inputNombresVer">Campo 6:</label>
                                                <input type="text" name="nombres" id="Campo6"
                                                    class="form-control form-control-sm" readonly>
                                            </div>
                                        </div>
                                    </div>
    ...
    function VisualizarAction(data) {
        var settings = {
            "url": '<?php echo urlApi; ?>PharmatencionProductoId/' + data,
            "method": "get",
            "headers": {
        ...
        $.ajax(settings).done(function(response) {
            $('#inputCodigoVer').val(response.data[0].CodigoProducto);
            $('#inputNombresVer').val(response.data[0].Retail);
            $('#inputCodigoBarraVer').val(response.data[0].Cod_Barra);
            $('#inputDescripcionVer').val(response.data[0].DescripcionProducto);
            $('#Campo1').val(response.data[0].Campo1);
            $('#Campo2').val(response.data[0].Campo2);
            $('#Campo3').val(response.data[0].Campo3);
            $('#Campo4').val(response.data[0].Campo4);
            $('#Campo5').val(response.data[0].Campo5);
            $('#Campo6').val(response.data[0].Campo6);
            $('#modal-PharmatencionVisualizar').modal('show');
    ...
    $(document).ready(function() {
        $('#TablePharmatencion').dataTable({
            ...
            "ajax": {
                "url": '<?php echo urlApi; ?>getPharmatencion',
                "type": "GET",
                "headers": {
                    'Authorization': 'bearer ' + localStorage.getItem('Token')
                },
