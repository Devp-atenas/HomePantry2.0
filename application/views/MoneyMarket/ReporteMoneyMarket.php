...
.tabulator {
    font-size: 12px;
            ...
            <section class="content">
                            ...
                            <div class="card card-primary card-outline">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row mb-0 mt-0 ">
                                        ...
                                        <div class="col-md-3">
                                            <label><i class="fas fa-barcode"></i>&nbsp;Código Barras:</label>
                                            <div class="form-group">
                                                <select class="form-control form-control-sm selectpicker"
                ...
                <div class="container-fluid" id="mainMoneyMarket" style="display:none;">
...
function fillFiltros() {
    ...
    $.ajax(settings)
        .done(function(response) {
            ...
            //
            if(sessionStorage.getItem('nuevo')==0){
                $('#cboFiltros').selectpicker('val', [sessionStorage.getItem('idReg')] );
                $('#cboFiltros').selectpicker('refresh');
            }
            //
        })
        .fail(function(jqXHR, textStatus) {
...
function ExcPrcWeek() {
    ...
    if (validarEntradaDatos()) {
        ...
        if (idMnd == 2) {
            ...
            sessionStorage.setItem('sTore', 'getRepMnyMrkPvtB/');
        }
        //
        var settings = {
...
function graPhData(data) {
    ...
    $('#mainMoneyMarket').css('display', 'block');
    $('#procesando').css('display', 'none');
    $('.selectpicker').prop('disabled', false);
    $('.selectpicker').selectpicker('refresh');
    //
