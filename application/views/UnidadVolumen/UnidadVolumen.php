...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="bi bi-droplet-half"></i>&nbsp;Mantenimiento de Unidad Medidas</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
<!-- Main content Agregar Unidad Medida 1111-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="inputUndMedida" name="inputUndMedida" placeholder="Ingrese Tamaño Rango ...">
                                </div>
                            </div>
                            <div class="col-md-3">
...
<!-- /Windows datatables Unidad Medida-->
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="card card-primary">
...
<div class="modal fade" id="modal-UndMedidaEditar">
                            ...
                            <form id="FormUndMedidaEdit">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <div class="inputText font-weight-bold">Unidad Medida:</div>
                                            <input type="text" class="form-control input-sm" id="inputUndMedidaEdit" placeholder="Ingrese nombre de la categoria ...">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    <div class="inputText font-weight-bold">Activo:</div>
                                ...
                                <div class="row" style="visibility:hidden;">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="inputIdEditUndMedida">id:</label>
                                            <input type="text" name="inputIdEditUndMedida" id="inputIdEditUndMedida"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="modal-UndMedidaVisualizar">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <div class="inputText font-weight-bold">Unidad Medida:</div>
                                        <input type="text" class="form-control input-sm" id="inputUndMedidaVer" readonly>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                <div class="inputText font-weight-bold">Activo:</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Unidad Medida Existente</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-12">
                        ...
                        <button id="idBotonAgregarUnidadMedida"type="button" class="btn btn-success" onclick="ejecutarAgregarUnidadMedida()">Agregar</button>
                    </div>
                </div>
            </div>
        </div>
