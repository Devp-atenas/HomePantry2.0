                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-sm" id="inputSegmento" name="inputSegmento" placeholder="Ingrese nombre del Segmento ...">
                                </div>
                            </div>
                            <div class="col-md-3">
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-12">
                        ...
                        <button id="idBotonAgregarSegmento"type="button" class="btn btn-success" onclick="ejecutarAgregarSegmento()">Agregar</button>
                    </div>
                </div>
            </div>
        </div>
