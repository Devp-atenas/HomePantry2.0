    ...
    <div class="container">
        ...
        <div id="wizard" class="form_wizard wizard_horizontal">
            <ul class="wizard_steps">
                ...
                <li>
                    <a href="#step-11">
                        <span class="step_no" data-toggle="tooltip" data-placement="bottom" title="Gastos"><img class="animation__shake" src="<?php echo base_url('dist/img/COMPOSICION.png')?>"></span>
                    </a>
                </li>
                <li>
                    <a href="#step-12">
            ...
            <div id="step-1">
                <form id="formUbicacionHogar">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Zona:</div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Coordenada X:</div>
                                <input type="text" maxlength="50" class="form-control" id="coordenadaX" name="coordenadaX" placeholder="Coordenada X ...">
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Coordenada Y:</div>
                                <input type="text" maxlength="50" class="form-control" id="coordenadaY" name="coordenadaY" placeholder="Coordenada Y ...">
                            </div>
                        </div>
                    </div>
                ...
                <form id="formCaracteristicaVivienda" action="" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Especifique:</div>
                                <input type="text" class="form-control input-sm" id="especifiqueTipoVivienda"  name="especifiqueTipoVivienda" placeholder="Especifique ..." disabled="disabled">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control-border" id="metrosVivienda" name="metrosVivienda">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control-border" id="puntosLuz" name="puntosLuz">
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control-border" id="ocupacionVivienda" name="ocupacionVivienda">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="custom-select form-control-border" id="montoVivienda" name="montoVivienda">
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Piso:</div>
                                <select class="custom-select form-control-border" id="selectPiso" name="selectPiso">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Paredes:</div>
                                <select class="custom-select form-control-border" id="selectParedes" name="selectParedes">
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="inputText font-weight-bold">Pinto en el Ultimo año: </div>
                            <div class="card">
                                <div class="form-group">
                                    <div class="form-check d-inline">
                                        <input class="form-check-input" type="radio" id="Pintura" name="Pintura" value="0">
                                        <label class="form-check-label">No</label>
                                    </div>
                                    <div class="form-check d-inline">
                                        <input class="form-check-input" type="radio" id="Pintura" name="Pintura" value="1">
                                        <label class="form-check-label">Si</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <div class="inputText font-weight-bold">Estacionamiento:</div>
                                <select class="custom-select form-control-border" id="selectPEstacionamiento" name="selectPEstacionamiento">
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <form id="formServiciosPublico" action="" method="post">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            <div class="inputText font-weight-bold">Posee Planta Electrica: </div>
                            <div class="card">
                                <div class="form-group">
                                    <div class="form-check d-inline">
                                        <input class="form-check-input" type="radio" id="PlantaElectrica" name="PlantaElectrica" value="0">
                                        <label class="form-check-label">No</label>
                                    </div>
                                    <div class="form-check d-inline">
                                        <input class="form-check-input" type="radio" id="PlantaElectrica" name="PlantaElectrica" value="1">
                                        <label class="form-check-label">Si</label>
                                    </div>
                                </div>
                            </div>
