            ...
            <div class="col-md-12">
                <div class="form-group row mb-0 mt-0">
                    ...
                    <div class="col-md-2">
                        ...
                        <select id="selectArea" name="selectArea" class="form-control form-control-sm" data-live-search="true">
                        </select>
                    </div>
                    <div class="col-md-2">
                        <label class="inputText font-weight-bold">Cantidad Semanas:</label>
...
<script src="<?php echo base_url('jsHP/jsPagoIncentivos.js') ?>"></script>
