...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-12">
                <h1><i class="bi bi-journal-text"></i>&nbsp;Reporte Hogar VS Hogar</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row mb-0 mt-0">
                    ...
                    <div class="col-md-3">
                        <label class="inputText font-weight-bold">Hogar 1:</label>
                        <select id="selectHogar1" name="selectHogar1" class="form-control form-control-sm">
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="inputText font-weight-bold">Hogar 2:</label>
                        <select id="selectHogar2" name="selectHogar2" class="form-control form-control-sm">
                        </select>
                    </div>
...
<script src="<?php echo base_url('jsHP/jsReporteHogarVSHogar.js') ?>"></script>
