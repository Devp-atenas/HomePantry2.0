        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <table id="TableTiendas" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Pais</th>
                    <th>Estatus</th>
          ...
          <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="form-group">
                  ...
                  <input type="text" name="inputIdEdit"  id="inputIdEdit" class="form-control" readonly>
                </div>
               <div class="form-group">
                  <label for="inputNombresEdit">Nombres:</label>
                  <input type="text" name="inputNombresEdit"  id="inputNombresEdit" class="form-control">
                </div>
                <div class="form-group">
                <div class="row">
                    <div class="col-12">
...
$('#TableTiendas').dataTable({
        ...
        "aoColumns": [
              { mData: 'pais',className: "text-center" } ,
              { mData: 'Activo',className: "text-center"},
            ]  ,
            "columnDefs": [ {
            "targets": 2,
            "orderable": true,
