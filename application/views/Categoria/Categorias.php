...
<!-- Windows Modal Editar Registros 22222-->
                            ...
                            <form id="FormCategoriaEdit">
                                ...
                                <div class="row" style="visibility:hidden;">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <label for="idCategoriaEdit">id:</label>
                            ...
                            <div class="row">
                                ...
                                <div class="inputText font-weight-bold">Medicina:</div>
                                    <div class="card">
                                        <div class="form-group">
                                        <div class="form-check d-inline">
                                                <input class="form-check-input" type="radio" id="medicinaView" name="medicinaView" value="0" readonly>
                                                <label class="form-check-label">No</label>
                                            </div>
                                            <div class="form-check d-inline">
                                                <input class="form-check-input" type="radio" id="medicinaView" name="medicinaView" value="1" readonly>
                                                <label class="form-check-label">Si</label>
                                            </div>
                                        </div>
                                    </div>
