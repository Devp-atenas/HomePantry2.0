...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class="bi bi-sort-numeric-up"></i>&nbsp;Mantenimiento Atributo 6</h1>
            </div>
        </div>
    </div><!-- /.container-fluid -->
</section>
        ...
        <div class="col-md-12">
            <div class="card card-primary">
                <div class="card-header">
                    <h3 class="card-title">Atributo 6</h3>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Atributo6 Existente</h3>
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                                    <i class="fas fa-minus"></i>
                                </button>
            ...
            <div class="modal-footer">
                <div class="row">
                    <div class="col-12">
                        ...
                        <button id="idBotonAgregarAtributo6"type="button" class="btn btn-success" onclick="ejecutarAgregarAtributo6()">Agregar</button>
                    </div>
                </div>
            </div>
        </div>
...
<script src="<?php echo base_url('jsDiccionario/jsAtributo6V1.js') ?>"></script>
